...
<div className='relative opacity-100 z-20 grid items-center justify-items-center nike-container' >
  <div className='grid items-center justify-center mt-28 md:mt-24 '>
    ...
    <div className='grid items-center gap-5 md:gap-3 absolute top-[33vh] lg:top-[27vh] left-[11%] xl:;eft-0 w-auto h-auto'>
{
videos?.map((val,i)=>(
  ...
  />
    ...
    <div className='grid items-center gap-4 absolute top-[33vh] lg:top-[27vh] right-0'>
      {
  ...
  <div className=' '><img src={img} alt="imgforshoe" className=' w-auto h-[45vh] lg:h-[35vh] md:h-[31vh] sm:h-[21vh] xsm:h-[19vh]  transitions-theme -rotate-[25deg] hover:rotate-0 cursor-pointer object-fill' /></div>
</div>
